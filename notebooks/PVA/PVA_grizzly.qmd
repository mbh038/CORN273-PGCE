...
You can clone the base grizzly bear model [here](https://insightmaker.com/insight/3cyvDTKAvL24DSvdyQSidb/Yellowstone-Grizzlies-basic). This model has not yet been parameterized.
...
The table is from [this scientific report](YellowstoneScience-BearIssue.pdf)
...
Again, you can clone the base grizzly bear model [here](https://insightmaker.com/insight/3cyvDTKAvL24DSvdyQSidb/Yellowstone-Grizzlies-basic) if you haven't already.
...
NOTE: if necessary, you can clone a density-dependent version of the grizzly model [here](https://insightmaker.com/insight/7s0bt8E1u5nqvZaQ4zwdma/Yellowstone-Grizzlies-density-dependent)
