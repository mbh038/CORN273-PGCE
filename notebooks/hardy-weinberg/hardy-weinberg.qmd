...
-   When a population is in Hardy-Weinberg equilibrium for a gene, it is not evolving for that gene, and allele frequencies for that gene will stay the same across generations.

-   For a population to actually be in Hardy-Weinberg equilibrium, five things must be true at once:
...
Thee are often referred to as the Hardy-Weinberg assumptions.
